...
void inputElemen(type_stack &namastack)
{
    ...
    cout<<"\nMasukkan Expresi aritmatika (ex: '34+4/2*10' ) \n";
    cout<<"Tekan enter setelah selesai menginputkan 1 element, sampai menginputkan '=' \n";
    string dataElemen;
    ...
    while(dataElemen != "=")
    {
        //melakukan perulangan untuk menginput per elemen ekspresi sampai selesai
        elm++;
        cout<<"elemen ke "<<elm<< " : ";
...
void infixToPostfix(type_stack &infix, type_stack &postfix)
{
    ...
    for(int k=0; k<=infix.top; k++)
    {
        ...
        {
            //jika bukan operator, berarti symbol atau angka
            Push(postfix,symbol);
        }
...
int main()
{
    ...
    do{
        ...
        cout << "             Menu Stack\n";
        cout << "**********************************************\n";
        cout << " 1) Input Expresi Aritmathik (Infix)\n";
        cout << " 2) Konvert Expresi Infix ke Postfix\n";
        cout << " 3) Hasil perhitungan Expresi\n";
        cout << " 4) Keluar\n";
        cout << "**********************************************\n\n";
        ...
        switch(menu)
        {
            case 1:
                ...
                if(!isFull(stackInfix,max_stack))
                {
                    ...
                    cout << "\nexpresi infix yang anda masukkan : ";
                    cout << "    ";
                    for(int i=0; i <=stackInfix.top; i++)
                    {
                        cout<<stackInfix.data[i];
                    }
                    cout << endl << endl;
                }
                else
            ...
            case 2:
                ...
                cout << "    ";
                for(int i=0; i <=stackPostfix.top; i++)
                {
